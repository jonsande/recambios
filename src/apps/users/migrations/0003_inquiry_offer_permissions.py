...
def add_inquiry_offer_permissions_to_internal_staff(apps, schema_editor):
...
def remove_inquiry_offer_permissions_from_internal_staff(apps, schema_editor):
    Group = apps.get_model("auth", "Group")
    Permission = apps.get_model("auth", "Permission")
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("users", "0002_inquiry_permissions"),
    ]

    operations = [
        migrations.RunPython(
            add_inquiry_offer_permissions_to_internal_staff,
            remove_inquiry_offer_permissions_from_internal_staff,
        ),
    ]
